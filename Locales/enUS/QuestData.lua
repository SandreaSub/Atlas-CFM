...
kQuestInstanceData.WailingCaverns.Horde[8] = {
    ...
    Note = red ..
        ...
        yellow .. "trash" .. white .. ", a Crystal of the Serpent from Lord Serpentis <Fanglord>" ..
        yellow ..
        "[7]" .. white .. ", and an Everchanging Essence from Lord Pythas <Fanglord> " .. yellow .. "[5]" .. white .. ".",
...
kQuestInstanceData.RagefireChasm.Horde[4] = {
    ...
    Note = "You find Bazzalan at " ..
        ...
        "[4]" ..
        white ..
        " and Jergosh at " .. yellow .. "[3]" .. white .. ". The questline starts at Warchief Thrall in Orgrimmar.",
...
kQuestInstanceData.Uldaman.Alliance[1] = {
    ...
    Note = "The Prequest starts at the Crumpled Map (Badlands " ..
        ...
        "53,33" ..
        white ..
        ").\nYou find Hammertoe Grez before you enter the instance, at " ..
        yellow .. "[1]" .. white .. " on the Entrance map.",
...
kQuestInstanceData.Uldaman.Alliance[8] = {
    ...
    Note = "The Hidden Chamber is at " ..
        ...
        yellow .. "[3]" .. white .. " and the Gni'kiv Medallion from Baelog's Chest " .. yellow .. "[1]" .. white ..
...
kQuestInstanceData.Uldaman.Alliance[11] = {
    ...
    Note = "The gems are at " ..
        ...
        white ..
        " in a Conspicous Urn, " ..
        yellow .. "[8]" .. white .. " from the Shadowforge Cache, and " .. yellow .. "[9]" .. white ..
...
kQuestInstanceData.Uldaman.Alliance[16] = {
    ...
    Note = red ..
        "Mage only" ..
        white .. ": The Obsidian Power Source drops from the Obsidian Sentinel at " .. yellow .. "[5]" .. white .. ".",
...
kQuestInstanceData.BlackrockDepths.Alliance[5] = {
    ...
    Note = "You get the prequest from Jalinda Sprig, too. You find Lord Incendius at " ..
        yellow .. "[10]" .. white .. ".",
...
kQuestInstanceData.BlackrockDepths.Alliance[21] = {
    ...
    Aim = "Find, and collect an Arcane Golem Core from Golem Lord Argelmach " ..
        yellow ..
        "[14]" .. white .. " in Blackrock Depths and return to Radgan Deepblaze at Blackrock Pass in Burning Steppes.",
...
kQuestInstanceData.BlackrockDepths.Horde[13] = {
    ...
    Note = "You get the prequest from Thunderheart (Badlands - Kargath " ..
        ...
        yellow .. "[3]" .. white .. ". The key to open the prison drops from High Interrogator Gerstahn " ..
...
kQuestInstanceData.BlackwingLair.Alliance[1] = {
    ...
    Note = "Only one person can loot the Shard. Anachronos (Tanaris - Caverns of Time " ..
        yellow .. "65,49" .. white .. ")",
...
kQuestInstanceData.BlackwingLair.Alliance[6] = {
    ...
    Location = "Arch Druid Dreamwind (Hyjal - Nordanaar " ..
        yellow .. "84.8,29.3" .. white .. " top floor of the big tree)",
    Note = "Nefarian " ..
        yellow ..
        "[9]" ..
        white ..
...
kQuestInstanceData.BlackfathomDeeps.Alliance[6] = {
    ...
    Note = red ..
        ...
        "[Blackfathom Deeps]" ..
        white ..
        ". You get the Large Soran'ruk Fragment in " ..
        yellow .. "[Shadowfang Keep]" .. white .. " from Shadowfang Darksouls.",
    Rewards = {
        Text = "Reward: Pick One",
...
kQuestInstanceData.BlackrockSpireLower.Alliance[6] = {
    ...
    Note = "To get Warosh's Mojo you have to evoke and kill Urok Doomhowl " ..
        ...
        yellow .. "[5]" .. white .. ". The Spear is at " .. yellow .. "[3]" ..
        white ..
...
kQuestInstanceData.BlackrockSpireLower.Alliance[9] = {
    ...
    Note = "You get the Gemstone of Spirestone from Highlord Omokk at " ..
        ...
        yellow .. "[9]" .. white .. " and the Gemstone of Bloodaxe from Overlord Wyrmthalak at " .. yellow .. "[19]" ..
        white ..
...
kQuestInstanceData.BlackrockSpireUpper.Alliance[8] = {
    ...
    Location = "Blackhand's Command (drops from Scarshield Quartermaster " ..
        yellow .. "[7] on Entrance Map" .. white .. ")",
    Note =
...
kQuestInstanceData.DireMaulEast.Alliance[1] = {
    ...
    Note = "Pusillin is in Dire Maul " ..
        yellow ..
        "East" ..
        white .. " at " .. yellow .. "[1]" .. white .. ". He runs when you talk to him, but stops and fights at " ..
...
kQuestInstanceData.DireMaulEast.Alliance[3] = {
    ...
    Note = "You find Alliz the Wildshaper in the " ..
        yellow .. "East" .. white .. " part of Dire Maul at " .. yellow .. "[5]" .. white ..
        ". The relict is in Silithius at " ..
        yellow .. "62,54" .. white .. ". The prequest comes from Rabine Saturna as well.",
...
kQuestInstanceData.DireMaulEast.Horde[2] = {
    ...
    Note = "Lethtendris is in Dire Maul " ..
        ...
        white ..
        " at " ..
        yellow .. "[3]" .. white .. ". The prequest comes from Warcaller Gorlach in Orgrimmar. He roams the entire city.",
...
kQuestInstanceData.DireMaulWest.Alliance[6] = {
    ...
    Note = red ..
        "Hunter only" ..
        white .. ": You turn the book in to Lorekeeper Mykos at the " .. yellow .. "1' Library" .. white .. ".",
    Rewards = {
        Text = "Reward:",
...
kQuestInstanceData.DireMaulWest.Alliance[7] = {
    ...
    Note = red ..
        "Mage only" ..
        white .. ": You turn the book in to Lorekeeper Kildrath at the " .. yellow .. "1' Library" .. white .. ".",
    Rewards = {
        Text = "Reward:",
...
kQuestInstanceData.DireMaulWest.Alliance[21] = {
    ...
    Aim = "Gather a Binding Fragment from Cliff Breakers in " ..
        ...
        yellow ..
        "[Dire Maul West]" .. white .. ", Slumberer's Shard from Weaver in the " .. yellow .. "[Sunken Temple]" ..
...
kQuestInstanceData.Maraudon.Alliance[5] = {
    ...
    Note =
        ...
        yellow .. "[5]" .. white .. ". Celebras is at " .. yellow ..
...
kQuestInstanceData.Maraudon.Horde[10] = {
    ...
    Attain = 41,
    Aim =
    "Cleanse the corruptive waters and its source inside of Maraudon and return to Ohona Riverbend at the Earthen Ring in the Stonetalon Mountains.",
    Location = "Ohona Riverbend (Stonetalon Mountains - The Earthen Ring " .. yellow .. "[52, 70]" .. white .. ").",
    Note = "'Noxxion' is at " ..
        yellow .. "[2]" .. white .. ", 'Lord Vyletongue' is at " .. yellow .. "[5]" .. white .. ".",
    Rewards = {
        Text = "Reward: Pick One",
...
kQuestInstanceData.MoltenCore.Alliance[8] = {
    ...
    Attain = 60,
    Aim =
    "To craft the cleansing torch, Gorn One Eye in the Timbermaw Tunnels south of Moonglade needs a Purging Flame and Star Woods logs.",
    Location = "Gorn One Eye (Timbermaw Tunnels " .. yellow .. "30, 64" .. white .. ")",
    Note = "Prequest start at Nathok (Azshara " ..
        yellow .. "39, 20" .. white .. "). 'Purging Flame' drops from 'Ragnaros' " .. yellow .. "[12]" .. white .. ".",
...
kQuestInstanceData.Naxxramas.Alliance[3] = {
    ...
    Location = "Commander Eligor Dawnbringer (Eastern Plaguelands - Light's Hope Chapel " ..
        yellow .. "82,58" .. white .. ")",
    Note =
...
kQuestInstanceData.Naxxramas.Alliance[4] = {
    ...
    Location = "Korfax, Champion of the Light (Eastern Plaguelands - Light's Hope Chapel " ..
        yellow .. "82,58" .. white .. ")",
...
kQuestInstanceData.ScarletMonasteryLibrary.Alliance[1] = {
    ...
    Note = "This quest line starts at Brother Crowley with quest 'Brother Anton' in Stormwind - Cathedral of Light (" ..
        ...
        yellow .. "SM: Cathedral [2]" .. white .. ", Herod at " .. yellow ..
...
kQuestInstanceData.ScarletMonasteryLibrary.Alliance[3] = {
    ...
    Note = red ..
        "Mage only" ..
        white ..
        ": You can find the book in the last corridor leading to Arcanist Doan (" .. yellow .. "[2]" .. white .. ").",
...
kQuestInstanceData.Scholomance.Alliance[7] = {
    ...
    Note = "You can find The Deed to Caer Darrow at " ..
        yellow ..
        "[12]" ..
        white .. ", The Deed to Brill at " .. yellow .. "[7]" .. white .. ", The Deed to Tarren Mill at " .. yellow ..
...
kQuestInstanceData.ShadowfangKeep.Horde[1] = {
    ...
    Note = "You find Deathstalker Adamant at " ..
        ...
        "[1]" ..
        white ..
        ". Deathstalker Vincent is on the right side when you go into the courtyard at " ..
        yellow .. "[2]" .. white .. ".",
    Rewards = {
        Text = "Reward:",
...
kQuestInstanceData.Stratholme.Alliance[7] = {
    ...
    Note = "You get the prequest from Magistrate Marduke (Western Plaguelands - Caer Darrow " ..
        yellow .. "70,73" .. white .. "). You find the sign near " ..
        yellow ..
        "[19]" .. white .. ". See also: " .. yellow .. "[The Lich, Ras Frostwhisper]" .. white .. " in Scholomance.",
...
kQuestInstanceData.Stratholme.Alliance[9] = {
    ...
    Location = "Duke Nicholas Zverenhoff (Eastern Plaguelands - Light's Hope Chapel " ..
        yellow .. "81,59" .. white .. ")",
...
kQuestInstanceData.Stratholme.Alliance[17] = {
    ...
    Note = red ..
        "Blacksmith only" .. white .. ": The Crimson Hammersmith is summoned at " .. yellow .. "[8]" .. white .. ".",
    Rewards = {
        Text = "Reward:",
...
kQuestInstanceData.Stratholme.Alliance[21] = {
    ...
    Note = "Second Feather of Medivh on the ground in the place where Elder Farwhisper (Lunar Festival) " ..
        ...
        yellow ..
        "[Undercity]" ..
        white .. " behind the entrance throne.\nThird Feather of Medivh " .. yellow .. "[Alterac Mountain]" ..
        white ..
        " on the end of first(western) cliff " .. yellow .. "[30.8,87.4]" .. white .. ".\nFourth Feather of Medivh " ..
...
kQuestInstanceData.TheRuinsofAhnQiraj.Alliance[2] = {
    ...
    Note = "Venoxis's Venom Sac drops from High priest Venoxis in " ..
        yellow ..
        "Zul'Gurub" .. white .. ". Kurinnaxx's Venom Sac drops in the " .. yellow .. "Ruins of Ahn'Qiraj" .. white ..
        " at " .. yellow .. "[1]" .. white .. ".",
    Rewards = {
        Text = "Reward: Pick One",
...
kQuestInstanceData.TheRuinsofAhnQiraj.Alliance[4] = {
    ...
    Note = red ..
        "Warlock only!" ..
        white .. " Turn in at Sand-buried Silver Blade (Ruins of Ahn'Qiraj " .. yellow .. "? " .. white .. ").",
...
kQuestInstanceData.TheStockade.Alliance[6] = {
    ...
    Note = "For more details about the preceding quest see " ..
        yellow ..
        "[Deadmines, The Defias Brotherhood]" ..
...
kQuestInstanceData.TheSunkenTemple.Alliance[13] = {
    ...
    Note = red ..
        ...
        ": Morphaz is at " ..
        yellow ..
        "[5]" .. white .. ". Greta Mosshoof is at Felwood - Emerald Sanctuary (" .. yellow .. "51,82" .. white .. ").",
...
kQuestInstanceData.TheSunkenTemple.Alliance[14] = {
    ...
    Note = red ..
        ...
        yellow ..
        "[5]" ..
        white .. ". Lord Jorach Ravenholdt is at Alterac Mountains - Ravenholdt (" .. yellow .. "86,79" .. white .. ").",
...
kQuestInstanceData.TheSunkenTemple.Alliance[18] = {
    ...
    Note = "Weaver " ..
        ...
        yellow ..
        "[4]" .. white .. ". Barrier to the Prophet will disappear after clearing 6 balcons " .. blue .. "[C]" ..
        white ..
        "\nFinishing this questline you get the necklace and you will be able to enter Hyjal raid instance Emerald Sanctum.",
    Prequest = "Into the Dream I -> Into the Dream II",
...
kQuestInstanceData.TheSunkenTemple.Horde[18] = {
    ...
    Location = "Insom'ni <The Great Hermit> (Kazon Island, north of Gillijim Isle " ..
...
kQuestInstanceData.ZulFarrak.Alliance[6] = {
    ...
    Note = "You get the Rod from Sergeant Bly. You can find him at " ..
        yellow .. "[4]" .. white .. " after the Temple event.",
    Rewards = {
        Text = "Reward: Pick One",
...
kQuestInstanceData.ZulGurub.Alliance[4] = {
    ...
    Location = "Dirk Thunderwood (Silithus - Cenarion Hold " .. yellow .. "52,39" .. white .. ")",
    Note = "Venoxis's Venom Sac drops from High priest Venoxis in " ..
        yellow .. "Zul'Gurub" .. white .. " at " .. yellow .. "[2]" .. white ..
        ". Kurinnaxx's Venom Sac drops in the " ..
        yellow .. "Ruins of Ahn'Qiraj" .. white .. " at " .. yellow .. "[1]" .. white .. ".",
    Rewards = {
        Text = "Reward: Pick One",
        { id = 22378 }, --Ravenholdt Slicer One-Hand, Sword
        { id = 22379 }, --Shivsprocket's Shiv Main Hand, Dagger
...
kQuestInstanceData.ZulGurub.Alliance[5] = {
    ...
    Attain = 60,
    Aim =
    "Infiltrate Zul’Gurub and return with High Speaker Jam’wahli’s Tusks to Insom’ni on Kazon Island near Gilijim’s Isle.",
    Location = "Insom'ni (Gillijim's Isle - Kazon Island " .. yellow .. "56,16" .. white .. ")",
    Note = "Prequest start at Nathok (Azshara " ..
        yellow ..
        "39, 20" ..
        white ..
        "). 'High Speaker Jam'wahli' (Zul'Gurub - " .. yellow .. "0, 0" .. white .. ") drop the 'Jam’wahli’s Tusks'.",
...
kQuestInstanceData.Gnomeregan.Alliance[1] = {
    ...
    Location = "Tinkmaster Overspark (Dun Morogh - Gnomeregan Reclamation Facility " ..
...
kQuestInstanceData.Gnomeregan.Alliance[5] = {
    ...
    Location = "Klockmort Spannerspan (Dun Morogh - Gnomeregan Reclamation Facility " ..
...
kQuestInstanceData.Gnomeregan.Alliance[6] = {
    ...
    Note = "You get the prequest from Gaxim Rustfizzle (Stonetalon Mountains " ..
        ...
        yellow .. "[3] on Entrance Map" .. white .. ". The 3005-B is at " .. yellow .. "[3]" ..
        white ..
...
kQuestInstanceData.Gnomeregan.Alliance[9] = {
    ...
    Note = "The Ring can be cleaned off at the Sparklematic 5200 in the Clean Room at " ..
        yellow .. "[2]" .. white .. ".",
...
kQuestInstanceData.Gnomeregan.Alliance[12] = {
    ...
    Location = "Weezan Littlegear (Dun Morogh - Gnomeregan Reclamation Facility " ..
...
kQuestInstanceData.FourDragons.Alliance[2] = {
    ...
    Note = "'Wail of Ysera' drops from 'Favor of Erennius' Solnius hard mode (Emerald Sanctum " ..
        yellow .. "[2]" .. white .. ").",
}
...
kQuestInstanceData.Reaver = {
    Story =
    "The Dark Reaver haunts the mists of Deadwind Pass, a spectral collector of relics paid for in blood. He was transformed from a common thief into an immortal phantom, destined to reap souls and treasures for a master who has long since departed.",
...
kQuestInstanceData.Reaver.Alliance[1] = {
    ...
    Attain = 60,
    Aim =
    "Find a use for the Rite of Resurrection. The ageless beings mentioned could very well be the mighty dragons roaming Azeroth.",
    Location = "Lord Blackwald II’s Riding Whistle drops from (Lower Karazhan Halls - Lord Blackwald II " ..
        yellow .. "[5] " .. white .. ")",
...
kQuestInstanceData.Clackora.Alliance[2] = {
    ...
    Note =
        "To summon Cla'ckora you need 3 parts of 'Ancient Idol of Cla'ckora', 10x 'Elemental Water' and 5x 'Lightning Eel'.\n'Top Piece of an Ancient Idol' is found inside 'Glowing Arctic Grayling' from fishing.\n'Middle Piece of an Ancient Idol' drops from Zul'Gurub - Gahz'ranka " ..
        yellow .. "[7]" .. white ..
...
kQuestInstanceData.Concavius.Alliance[1] = {
    ...
    Attain = 60,
    Aim =
    "Find the location the shard is pulling you towards. Your mind tells you to seek the dark energies of profane areas.",
...
kQuestInstanceData.Nerubian.Alliance[1] = {
    ...
    Location = "'Crypt Lord’s Beckoning' drops from 'Anub'Rekhan' in (Naxxramas - Spider Wing " ..
        yellow .. "[1]" .. white .. ".",
    Note = "Turn in the quest to 'Tirion Fordring' in Eastern Plaguelands " ..
        yellow ..
        "[6, 44]" .. white .. ". 'Hallowed Cross' drops from Scarlet elite mobs in Western and Eastern Plaguelands.",
}
...
kQuestInstanceData.Azuregos.Alliance[3] = {
    ...
    Note = "Turn in the quest to 'Spirit of Azuregos' in Azshara " ..
        yellow ..
        "[56, 83]" ..
        white ..
        ". 'Blue Dragon Essence' drops from elite blue dragons and whelps in Azshara, Winterspring and the Moonwhisper Coast.",
}
for i = 1, 3 do
...
kQuestInstanceData.LordKazzak.Alliance[1] = {
    ...
    Note = "Turn in the quest to 'Daio the Decrepit' in Blasted Lands " ..
        yellow ..
        "[34, 50]" ..
        white .. ". 'Netherrich Demon Blood' drops from elite demons in Blasted Lands, Winterspring and the Hyjal.",
}
...
kQuestInstanceData.BGAlteracValleyNorth.Alliance[5] = {
    ...
    Note = "The supplies can be found in the Coldtooth Mine at (Alterac Valley - South " ..
        yellow .. "[6]" .. white .. ").",
}
kQuestInstanceData.BGAlteracValleyNorth.Alliance[6] = {
    ...
    Location = "Stormpike Quartermaster (Alterac Valley - North " .. yellow .. "[7]" .. white .. ")",
    Note = "The supplies can be found in the Irondeep Mine at (Alterac Valley - North " ..
        yellow .. "[1]" .. white .. ").",
}
...
kQuestInstanceData.Ostarius.Horde[1] = {
    ...
    Location = "Uldum Pedestal (Tanaris " .. yellow .. "37,81" .. white .. ")",
    Note = "Prequest from Sage Truthseeker (Thunder Bluff " ..
        yellow .. "34,47" .. white .. ").You need to kill Ostarius.",
...
kQuestInstanceData.GilneasCity.Alliance[3] = {
    ...
    Location = "Baron Caliban Silverlaine (Gilneas - Ravenshire (main building) " ..
...
kQuestInstanceData.GilneasCity.Alliance[5] = {
    ...
    Location = "Magus Orelius <Kirin Tor> (Gilneas - Ravenshire (main building) " ..
...
kQuestInstanceData.GilneasCity.Alliance[6] = {
    ...
    Note =
        ...
        "58.4,67.8" ..
        white ..
        ")\nThe Greymane Crown drops from Genn Greymane " ..
        yellow .. "[8]" .. white .. ", last boss on the top of the tower.",
    Prequest =
...
kQuestInstanceData.EmeraldSanctum.Alliance[4] = {
    ...
    Attain = 60,
    Aim =
    "Slay Solnius and reunite Thil’phoral with the splinter he possesses at the Vine of Aln inside the Emerald Sanctum.",
    Location = "Altar of Depths (Azshara " .. yellow .. "[89, 56]" .. white .. ").",
    Note = red ..
        "Warlocks only!" ..
        white ..
        "Prequest starts from 'Mass of Writhing Tentacles' drops from (Timbermaw Hold " ..
        yellow .. "[10]" .. white .. "). 'Solnius' is at " .. yellow .. "[2]" .. white .. ".",
...
kQuestInstanceData.TowerofKarazhan.Alliance[1] = {
    ...
    Note = "Obsidian Rod " ..
        ...
        yellow ..
        "40.9, 79.3" ..
        white .. "), Wine for Kyleson prequest start at the The Cook " .. yellow .. "(Lower Karazhan Halls [e])",
...
kQuestInstanceData.TowerofKarazhan.Alliance[4] = {
    ...
    Note = "The Cook near (" ..
        yellow .. "[Lower Karazhan Halls - e]" .. white .. ".\nA quest to obtain a cooking recipe.",
...
kQuestInstanceData.TowerofKarazhan.Alliance[6] = {
    ...
    Note = red ..
        "Druid only" ..
        white ..
        ": Lorekeeper Lydros (Dire Maul - West or North " ..
...
kQuestInstanceData.DragonmawRetreat.Alliance[6] = {
    ...
    Location = "Letter from Korlag Doomsong (Dragonmaw Retreat - Zuluhed the Whacked " ..
        yellow .. "[10]" .. white .. ")",
    Note = "Turn in to 'Magistrate Hurdam Toughhand' at 'Grim Reaches' " ..
        yellow ..
        "51, 58" ..
        white ..
...
kQuestInstanceData.DragonmawRetreat.Horde[6] = createInheritedQuest(
    ...
    {
        Id = 41657,
        Note = "Turn in to 'Commander Aggnash' at Grim Reaches - Shatterblade Pose - " ..
            yellow ..
            "60, 30" ..
            white ..
...
kQuestInstanceData.StormwroughtRuins.Alliance[1] = {
    ...
    Note = "'Key to Stormwrought Castle' is a reward from the quest chain starting at Drak’thul (Balor " ..
        yellow ..
        "55, 19" ..
        white .. ") unlocks access to boss 6+. 'Crown of Balor' drops from 'Duke Balor the IV' " .. yellow .. "[4]",
    Rewards = {
        Text = "Reward: Pick One",
...
kQuestInstanceData.WindhornCanyon.Horde[2] = {
    ...
    Note = "Prequest start at 'Brave Moonhorn' (Thousand Needles - The Great Lift " ..
        yellow .. "32, 22" .. white .. "). 'Prophet Stormhoof' is at " .. yellow .. "[6]" .. white .. ".",
    Prequest =
    "Message to Freewind Post -> Pacify the Centaur -> Grimtotem Spying -> Rumors of the Deathtotem -> Information for Cairne",
    Rewards = {
        Text = "Reward: Pick One",
...
kQuestInstanceData.WindhornCanyon.Horde[3] = {
    ...
    Note = red ..
        "Shaman only! " ..
        white ..
        "Prequest start from 'Windtorn Crest Stone', which drops from Razorgust in Stonetalon Mountains (" ..
        yellow .. "30, 19" .. white .. "). 'Ambassador Vortalus' is at " .. yellow .. "[3]" .. white .. ".",
...
kQuestInstanceData.FrostmaneHollow = {
    Story =
    "Frostmane Hollow is an instance dungeon located in Dun Morogh, just south of the Ironforge Airfields. It is the sanctum of the Frostmane clan and a de-facto capital for all of trollkind in Dun Morogh.",
...
kQuestInstanceData.TimbermawHold.Alliance[1] = { --TODO translate
    ...
    Attain = 50,
    Aim =
    "Enter Timbermaw Hold and retrieve the corrupted draenethyst. Bring them to Riftmaster Ral’pekta in Moro’gai Village of Moonwhisper Coast if you are successful.",
    Location = "Riftmaster Ral’pekta (Moonwhisper Coast - Moro’gai Village " .. yellow .. "65, 63" .. white .. ")",
    Note = "Prequest start at '' (" ..
        yellow .. "0, 0" .. white .. "). 'Selenaxx Foulheart' is at " .. yellow .. "[7]" .. white .. ".",
...
kQuestInstanceData.TimbermawHold.Alliance[2] = { --TODO translate
    ...
    Attain = 60,
    Aim =
    "Present Narkogg the Dark in the Maw of Ursoc in Azshara with proof of slaying Karrsh the Sentinel in Timbermaw Hold.",
...
kQuestInstanceData.TimbermawHold.Alliance[3] = { --TODO translate
    ...
    Attain = 60,
    Aim =
    "Collect Withermaw Totems from Withermaw Shaman inside Timbermaw Hold and bring them to Narkogg the Dark in the Maw of Ursoc in Azshara.",
    Location = "Narkogg the Dark (Azshara - Maw of Ursoc " .. yellow .. "39, 21" .. white .. ")",
...
kQuestInstanceData.TimbermawHold.Alliance[4] = { --TODO translate
    ...
    Attain = 60,
    Aim =
    "Narkogg the Dark in the Maw of Ursoc in Azshara requires specific materials for the purification salve. Bring them to him.",
    Location = "Narkogg the Dark (Azshara - Maw of Ursoc " .. yellow .. "39, 21" .. white .. ")",
    Note = "'Heart of Nemasra' drop from 'Nemasra' in Ungoro Crater (" ..
        yellow ..
        "35, 25" ..
        white .. "), 'Grammon’s Tongue' from 'Grammon the Ageless' Feralas (" .. yellow .. "28, 95" .. white ..
...
kQuestInstanceData.TimbermawHold.Alliance[5] = { --TODO translate
    ...
    Attain = 60,
    Aim =
    "Retrieve Narkogg’s Medicine Pouch and the Putrid Flower from within Timbermaw Hold for Narkogg the Dark in the Maw of Ursoc in Azshara.",
    Location = "Narkogg the Dark (Azshara - Maw of Ursoc " .. yellow .. "39, 21" .. white .. ")",
...
kQuestInstanceData.TimbermawHold.Alliance[9] = { --TODO translate
    ...
    Attain = 60,
    Aim =
    "Enter Timbermaw Hold and destroy Peroth’arn. Return to Narkogg the Dark in the Maw of Ursoc in Azshara after you have cleansed the corruption plagueing Kalimdor!",
    Location = "Gorn One Eye (Timbermaw Tunnels " .. yellow .. "30, 64" .. white .. ")",
    Note = "Prequest start at Nathok (Azshara - Maw of Ursoc " ..
        yellow .. "39, 20" .. white .. "). 'Peroth'arn' is at " .. yellow .. "[10]" .. white .. ".",
...
kQuestInstanceData.TimbermawHold.Horde[11] = { --TODO translate
    ...
    Attain = 60,
    Aim =
    "Vanquish Loktanag the Vile inside Timbermaw Hold and return to Muln Earthfury at the Earthen Ring in the Stonetalon Mountains.",
